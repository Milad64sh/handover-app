...
const WeeklyUploadedForms = () => {
  ...
  const fetchForms = async (page, limit) => {
    try {
      ...
      const url = `http://localhost:5000/weekly-handovers?staff=${staffQueryString}&service=${serviceQueryString}&page=${page}&limit=${limit}`;
      const responseData = await sendRequest(url);
      console.log(responseData);
      setLoadedForms(responseData.allWeeklyForms);
      setPaginationData({
...
export default WeeklyUploadedForms;
