...
import styles from './dailyUplaodedForms.module.scss';
...
const DailyUploadedForms = () => {
  ...
  const fetchForms = async (page, limit) => {
    try {
      ...
      const url = `http://localhost:5000/daily-handovers?staff=${staffQueryString}&service=${serviceQueryString}&page=${page}&limit=${limit}`;
      const responseData = await sendRequest(url);
      console.log(responseData);
      setLoadedForms(responseData.allDailyForms);
      setPaginationData({
...
export default DailyUploadedForms;
